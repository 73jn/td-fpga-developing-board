  ...
  begin
    if reset = '1' then
      ...
      case mainState is 
        ...
        when print =>
          speed <= std_ulogic_vector(resize(10*to_unsigned(rotationCounter, speed'length), speed'length)); -- * 10 pour tr/secondes
          mainState <= setToZero;
        when setToZero =>
          rotationCounter := 0;
          mainState <= count;
